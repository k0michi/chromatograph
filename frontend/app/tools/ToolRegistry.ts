...
export type ToolId = "brush" | "eraser" | "eyedropper" | "move" | "zoom" | "rotate";
...
export interface ToolSettingsMap {
  ...
  readonly eyedropper: PassiveToolSettings;
...
export interface ToolDefinition {
  ...
  readonly options: "paint" | "eyedropper" | "move" | "zoom" | "rotate";
...
export const TOOL_DEFINITIONS: Readonly<Record<ToolId, ToolDefinition>> = {
  ...
  eyedropper: { id: "eyedropper", label: "Eyedropper", glyph: "I", shortcut: "I", keys: ["i"],
    cursor: "crosshair", options: "eyedropper" },
...
export const TOOL_ORDER: readonly ToolId[] = ["brush", "eraser", "eyedropper", "move", "zoom", "rotate"];
...
export function createDefaultToolSettings(): ToolSettingsMap {
  return { brush: defaultPaintSettings(), eraser: defaultPaintSettings(),
    eyedropper: { kind: "passive" }, move: { kind: "passive" },
    zoom: { kind: "passive" }, rotate: { kind: "passive" } };
}
